<template>
  <div>
    <!-- Modal -->
    <div class="modal fade" id="joinNew" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Join Member Baru Sponsor : <span style="text-transform: capitalize;">{{profile.name}}</span></h5>
