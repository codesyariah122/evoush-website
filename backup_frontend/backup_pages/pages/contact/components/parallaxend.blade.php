...
<script type="text/javascript">
	new Vue({
		el: '#parallax-end-contact',
		data(){
			return {
				parallax: {
					style: {
						'background-image': `url(https://raw.githubusercontent.com/codesyariah122/bahan-evoush/main/images/banner/new_banner9.jpg)`,
					},
