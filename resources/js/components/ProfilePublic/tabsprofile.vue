		...
		<div class="col-md-12 col-xs-12 col-sm-12 mt-2 mb-5">
			...
			<ul class="nav nav-pills mb-5 justify-content-center" id="pills-tab" role="tablist">
				<li class="nav-item" role="presentation">
					<a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true"><i class="fas fa-fw fa-laptop-house fa-2x"></i> Home</a>
				</li>
				<li class="nav-item" role="presentation">
					<a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false"><i class="fas fa-address-card fa-fw fa-2x"></i> Story</a>
				</li>
				<li class="nav-item" role="presentation">
					<a class="nav-link" id="pills-sponsor-tab" data-toggle="pill" href="#pills-sponsor" role="tab" aria-controls="pills-sponsor" aria-selected="false"><i class="fas fa-fw fa-users fa-2x"></i> Members</a>
				</li>
			</ul>
				...
				<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
					<div class="container">
							...
							<div class="col-md-6 col-xs-12 col-sm-12">
								<center>
									<ul style="list-style-type: none;" class="profile-data">
										...
										<li class="mt-2 mb-3"><b>{{profile.city}} | {{profile.province}}</b></li>
							...
							<div class="col-md-6 col-xs-12 col-sm-12">
								<center>
									<h4 class="text-primary mt-4">Join member {{profile.username}} : </h4>
	                                  ...
	                                  <a class="btn btn-success" data-toggle="modal" data-target="#joinNew">Join Now</a>
								</center>
							</div>
						...
						<div class="row justify-content-center mt-5 mb-5">
							<div class="col-md-6 col-xs-12 col-sm-12">
								<blockquote class="mb-2 blockquote-footer text-center">
							...
							<div class="col-md-6 col-xs-12 col-sm-12">
								<div v-if="members.message">
									<div class="alert alert-danger" role="alert">
										<b>{{profile.username}}</b>, {{members.message}}
									</div>
								</div>
								<div v-else>
									<h1>Member sedang diperbaharui</h1>
								</div>
							</div>
						</div>
					</div>
