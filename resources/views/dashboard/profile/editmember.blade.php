...
<div id="edit-profile">
 ...
 --}}
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" value="{{old('name') ? old('name') : $profile->name}}" class="form-control">
                      ...
                      <div class="form-group">
                          ...
                          {{(in_array('ADMIN', json_decode(Auth::user()->roles))) ? '' : 'readonly'}}
                          >
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="email" value="{{old('email') ? old('email') : $profile->email}}" id="email" class="form-control">
                        <div class="invalid-feedback">
                          {{$errors->first('email')}}
                        </div>
                        <br>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="phone" value="{{old('phone') ? old('phone') : $profile->phone}}" id="phone" class="form-control">
                        <div class="invalid-feedback">
                          {{$errors->first('phone')}}
                        </div>
                        <br>
                      ...
                      <div class="form-group">
                        ...
                        <small class="text-danger">Untuk quotes minimal panjang karakter 100 karakter</small>
                      ...
                      <div class="form-group">
                        ...
                        <input value="{{old('youtube') ? old('youtube') : $profile->youtube}}"
                          ...
                          placeholder="Youtube Chanel Profile" type="text" name="youtube" id="youtube"/>
                        <div class="invalid-feedback">
