<!-- Sidebar -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseProfile" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo e(route('profile.edit', [Auth::user()->id])); ?>">Edit Profile</a>
                    </div>
                </div>
            </li>
        ...
        <!-- End of Sidebar --><?php /**PATH C:\Users\Evoush\puji_titip\evoush-backend\resources\views/layouts/dashboard/Partial/staff/sidebarstaff.blade.php ENDPATH**/ ?>