...
<script>
	import Hero from '../../components/ProfileLogin/hero'
	import PanelProfile from '../../components/ProfileLogin/panelprofile'
	import ParallaxProfile from '../../components/ProfileLogin/parallaxprofile'
	...
	export default{
		...
		methods: {
			getProfileData(){
				...
				this.axios(`/api/evoush/profile-data/login/${username}`)
				.then( res => {
