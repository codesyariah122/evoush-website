<!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{route('evoush.articles')}}" target="_blank">
            ...
            <li class="nav-item">
                ...
                <div id="collapseMember" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{route('category-article.index')}}">Category Articles</a>
                        <a class="collapse-item" href="{{route('articles.index')}}">List Artciles</a>
                    </div>
                </div>
            </li>
