...
<script type="text/javascript" src="<?php echo e(asset('js/WebApp.js')); ?>"></script>
...
@font-face {
 font-family: 'Walkway';
 src:  url("<?php echo e(asset('fonts/walkway/Walkway.ttf.woff')); ?>") format("woff"); 
 font-weight: normal;
 font-style: normal;
}
*,
...
</style><?php /**PATH C:\Users\Evoush\puji_titip\_backup\evoush-website\resources\views/layouts/homepage/partials/head.blade.php ENDPATH**/ ?>