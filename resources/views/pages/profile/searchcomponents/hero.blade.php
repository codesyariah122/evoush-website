...
<script type="text/javascript">
	new Vue({
		...
		data(){
			return {
				image: {
					backgroundImage: `url(https://raw.githubusercontent.com/codesyariah122/bahan-evoush/main/images/banner/search/banner_search2.jpg)`
				},
				brand: "voush",
				title: `Search <span style="color:#ff3b40;">Member evoush</span>`,
